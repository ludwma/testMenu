<?php
// source: C:\wampnovej\www\app/config/config.neon 
// source: C:\wampnovej\www\app/config/config.local.neon 

class Container_43faa3d06f extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Model\MenuManager' => [1 => ['27_App_Model_MenuManager']],
			...
			'App\Presenters\AdministrationPresenter' => [1 => ['application.1']],
		...
		'services' => [
			...
			'27_App_Model_MenuManager' => 'App\Model\MenuManager',
			'28_App_Model_UserManager' => 'App\Model\UserManager',
			'application.1' => 'App\Presenters\AdministrationPresenter',
	...
	{
		parent::__construct([
			'appDir' => 'C:\wampnovej\www\app',
			'wwwDir' => 'C:\wampnovej\www\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\wampnovej\www\app/../temp',
		]);
	}
	...
	/**
	 * @return App\Model\MenuManager
	 */
	public function createService__27_App_Model_MenuManager()
	{
		$service = new App\Model\MenuManager($this->getService('database.default.context'));
		return $service;
	}
	...
	/**
	 * @return App\Presenters\AdministrationPresenter
	 */
	public function createServiceApplication__1()
	{
		$service = new App\Presenters\AdministrationPresenter($this->getService('27_App_Model_MenuManager'));
	...
	{
		$service = new App\Presenters\HomepagePresenter($this->getService('27_App_Model_MenuManager'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\wampnovej\www\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\wampnovej\www\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\wampnovej\www\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=menu', 'root',
			NULL, ['lazy' => TRUE]);
	...
	{
		return new Container_43faa3d06f_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_43faa3d06f_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_43faa3d06f $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\wampnovej\www\app/../temp/cache/latte');
